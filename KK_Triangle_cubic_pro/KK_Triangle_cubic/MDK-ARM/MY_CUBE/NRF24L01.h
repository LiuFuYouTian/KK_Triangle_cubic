...
#define NRF24L01_CE_CLK_ENABLE()                      __HAL_RCC_GPIOC_CLK_ENABLE()    
...
#define NRF24L01_IRQ_CLK_ENABLE()                     __HAL_RCC_GPIOC_CLK_ENABLE()    
...
uint8_t NRF_Transmit_Dispose(void);
void NRF_RX_DIS(void);
void NRF_Transmit(void);
extern uint8_t NRF_RX_BUFF[32];
extern uint8_t NRF_TX_BUFF[32];
extern CHANNEL_VAL_TYPE CHANNEL;
