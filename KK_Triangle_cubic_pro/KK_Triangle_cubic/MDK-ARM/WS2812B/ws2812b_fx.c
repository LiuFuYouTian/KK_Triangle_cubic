...
void mode_theater_chase(void)
{
   ...
   theater_chase(Ws28b12b_Segments[mActualSegment].ModeColor[0], Ws28b12b_Segments[mActualSegment].ModeColor[1]);
...
//  return twinkle(Ws28b12b_Segments[mActualSegment].ModeColor[0], Ws28b12b_Segments[mActualSegment].ModeColor[1]);
	  twinkle(Ws28b12b_Segments[mActualSegment].ModeColor[0], Ws28b12b_Segments[mActualSegment].ModeColor[1]);
}
...
//  return chase(Ws28b12b_Segments[mActualSegment].ModeColor[0], Ws28b12b_Segments[mActualSegment].ModeColor[1], Ws28b12b_Segments[mActualSegment].ModeColor[2]);
  ...
  chase(Ws28b12b_Segments[mActualSegment].ModeColor[0], Ws28b12b_Segments[mActualSegment].ModeColor[1], Ws28b12b_Segments[mActualSegment].ModeColor[2]);
}
...
//  return chase(Ws28b12b_Segments[mActualSegment].ModeColor[0], WHITE, WHITE);
   ...
   chase(Ws28b12b_Segments[mActualSegment].ModeColor[0], WHITE, WHITE);
}
...
//  return chase(Ws28b12b_Segments[mActualSegment].ModeColor[0], BLACK, BLACK);
   ...
   chase(Ws28b12b_Segments[mActualSegment].ModeColor[0], BLACK, BLACK);
}
...
{
  chase(WHITE, Ws28b12b_Segments[mActualSegment].ModeColor[0], Ws28b12b_Segments[mActualSegment].ModeColor[0]);
...
//  return chase(color_wheel(Ws28b12b_Segments[mActualSegment].AuxParam), WHITE, WHITE);
  ...
  chase(color_wheel(Ws28b12b_Segments[mActualSegment].AuxParam), WHITE, WHITE);
}
...
//  return running(Ws28b12b_Segments[mActualSegment].ModeColor[0], WHITE);
  ...
  running(Ws28b12b_Segments[mActualSegment].ModeColor[0], WHITE);
}
...
//  return fireworks(Ws28b12b_Segments[mActualSegment].ModeColor[0]);
  ...
  fireworks(Ws28b12b_Segments[mActualSegment].ModeColor[0]);
}
...
//  return fireworks(color_wheel(rand()%256));
  ...
  fireworks(color_wheel(rand()%256));
}
...
//}
	  tricolor_chase(Ws28b12b_Segments[mActualSegment].ModeColor[0], Ws28b12b_Segments[mActualSegment].ModeColor[1], Ws28b12b_Segments[mActualSegment].ModeColor[2]);
}
...
//  return tricolor_chase(RED, WHITE, BLACK);
  ...
  tricolor_chase(RED, WHITE, BLACK);
}
